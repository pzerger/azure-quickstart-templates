...
If(([System.IO.File]::Exists("$($TempDir)\_IIS_Enabled_Failed.txt")) -or (![System.IO.File]::Exists("$($TempDir)\_IIS_Enabled_Sucessfully.txt")))
	{
		# Removing previous run 'Failed' Text File if it exists.
		[System.IO.File]::Delete("$($TempDir)\_IIS_Enabled_Failed.txt")
...
If(([System.IO.File]::Exists("$($TempDir)\_IIS_Directory_Browsing_Enabled_Failed.txt")) -or (![System.IO.File]::Exists("$($TempDir)\_IIS_Directory_Browsing_Enabled_Sucessfully.txt")))
	{	
		# Removing previous run 'Failed' Text File if it exists.
		[System.IO.File]::Delete("$($TempDir)\_IIS_Directory_Browsing_Enabled_Failed.txt")
